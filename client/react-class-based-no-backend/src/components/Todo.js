            ...
            <div className="flex mb-4 items-center">
                ...
                {completed &&
                    <button
                        ...
                        onClick={() => handleUpdateStatusClick(id)}>Not Done</button>
                }
                {!completed &&
                    <button
                        ...
                        onClick={() => handleUpdateStatusClick(id)}>Done</button>
                }
                <button
                    className="flex-no-shrink p-2 ml-2 border-2 rounded text-red-600 border-red-600 hover:text-white hover:bg-red-600" onClick={() => handleDeleteClick(id)}>Remove
                </button>
            </div>
        )
    }
